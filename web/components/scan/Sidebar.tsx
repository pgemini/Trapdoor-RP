...
const SAMPLES: SampleButton[] = [
  ...
  },
  {
    key: "audio_voicemail",
    name: "Voicemail · Alex",
    desc: "Spoken injection — caught via Whisper transcription.",
    tag: "WAV",
    tagTone: "warn",
    icon: <FileAudio size={14} />,
  },
  {
    key: "audio_meeting",
    name: "Meeting clip",
    desc: "Spoken SYSTEM: role-spoof in a team stand-up.",
    tag: "WAV",
    tagTone: "warn",
    icon: <FileAudio size={14} />,
  },
  ...
  },
  {
    ...
    desc: "On-screen text + MP4 metadata atoms.",
    tag: "MP4",
    tagTone: "danger",
    icon: <FileType size={14} />,
  },
  {
    ...
    desc: "Frame OCR + container metadata (©cmt / ©nam).",
    tag: "MP4",
    tagTone: "danger",
    icon: <FileType size={14} />,
  },
