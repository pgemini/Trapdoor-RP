...
export interface SampleMeta {
  key: SampleKey;
  filename: string;
  badge: "PDF" | "PNG" | "DOCX" | "MD" | "WAV" | "XLSX" | "MP4";
  tag: "pdf" | "img" | "doc" | "md" | "aud" | "xls" | "vid";
  label: string;
  subtitle: string;
  modality: string;
}
...
export const SAMPLES: SampleMeta[] = [
  ...
  { key: "audio_voicemail",    filename: "voicemail_alex.wav",        badge: "WAV",  tag: "aud", label: "Voicemail · Alex",  subtitle: "Spoken injection (Whisper STT)",  modality: "audio"          },
  { key: "audio_meeting",      filename: "meeting_clip.wav",          badge: "WAV",  tag: "aud", label: "Meeting clip",      subtitle: "Spoken SYSTEM: role-spoof",       modality: "audio"          },
  ...
  { key: "video_announcement", filename: "company_announcement.mp4",  badge: "MP4",  tag: "vid", label: "Announcement video",subtitle: "On-screen text + MP4 metadata",   modality: "video"          },
  { key: "video_screen",       filename: "screen_recording.mp4",      badge: "MP4",  tag: "vid", label: "Screen recording",  subtitle: "Frame OCR + container atoms",     modality: "video"          },
];
